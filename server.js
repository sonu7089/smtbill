...
app.post("/app/loginTried", (req, res) => {
    ...
    axios.get('https://api.msg91.com/api/v5/otp?authkey=329039AEVFbxMMy9n5ebbdf3fP1&template_id=5ebbdf67d6fc051be8752693&extra_param={}&mobile=' + MobileNo + '&invisible=1&otp=')
        .then((response) => {
...
app.post("/app/loginVerify", (req, res) => {
    ...
    let sts;
    let name ;
    axios.post('https://api.msg91.com/api/v5/otp/verify?mobile=' + mno + '&otp=' + otp + '&authkey=329039AEVFbxMMy9n5ebbdf3fP1', {
        otp: otp
    })
        .then((response) => {
            console.log(response.data);
        ...
        WHERE id = ?`;
            ...
            if(sts==1){
                ...
                if (result2[0] != undefined) {
                    //serv_resp_v.name = result2[0] ;
                    name = result2[0] ;

                } else {
                    //serv_resp_v.name = "New Employee" ;
                    name = "New Employee" ;
                }
    ...
    /*
     ...
     console.log(serv_resp_v);
     res.status(200).send(serv_resp_v);  //check is it correct way to append id part to our response to be accessed in front end
     res.end();
...
app.post("/app/loginResend", (req, res) => {
    ...
    let mno = req.body.mno;
    axios.post('https://api.msg91.com/api/v5/otp/retry?mobile=' + mno + '&authkey=329039AEVFbxMMy9n5ebbdf3fP1', {
        mno: mno
    })
        .then((response) => {
...
app.listen(3000, () => {      //Express Server starts to listen for calls
    ...
    //server.listen(3050,'192.168.43.11')
    //  })
});
